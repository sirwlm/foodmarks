...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('fm', ['Recipe'])

        # Adding model 'Tag'
        db.create_table('fm_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fm.Recipe'])),
        ...
        db.send_create_signal('fm', ['Tag'])


    def backwards(self, orm):
        
        # Deleting model 'Recipe'
        db.delete_table('fm_recipe')

        # Deleting model 'Tag'
        db.delete_table('fm_tag')
