...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('fm_recipe', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Recipe.title'
        db.alter_column('fm_recipe', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
